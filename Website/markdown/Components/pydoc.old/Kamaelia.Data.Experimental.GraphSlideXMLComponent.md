---
pagename: Components/pydoc.old/Kamaelia.Data.Experimental.GraphSlideXMLComponent
last-modified-date: 2008-09-20
page-template: default
page-type: text/markdown
page-status: current|legacy|needsupdate|deprecated|recommended
---
Kamaelia.Data.Experimental.GraphSlideXMLComponent
=================================================

class GraphSlideXMLComponent(Axon.Component.component,.Data.Experimental.GraphSlideXMLPars)
-------------------------------------------------------------------------------------------
