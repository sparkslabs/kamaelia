---
pagename: Components/pydoc.old/Kamaelia.SampleTemplateComponent.StandardStyleComponent
last-modified-date: 2008-09-20
page-template: default
page-type: text/markdown
page-status: current|legacy|needsupdate|deprecated|recommended
---
Kamaelia.SampleTemplateComponent.StandardStyleComponent
=======================================================

class StandardStyleComponent(Axon.Component.component)
------------------------------------------------------
...
### \_\_init\_\_(self, label, looptimes)
