...
urlpatterns = patterns('',
    ...
    (r'^programmesv2/(?P<pid>\w+)/(?P<timestamp>\d+)/(?P<aggregated>\D+)$', 'bookmarks.output.views.rawtweetsv2'),
    (r'^programmesv2/(?P<pid>\w+)/(?P<timestamp>\d+)$', 'bookmarks.output.views.rawtweetsv2'),
