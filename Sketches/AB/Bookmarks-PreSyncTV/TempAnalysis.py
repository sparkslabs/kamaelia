...
if __name__ == "__main__":
    ...
    timediff = -3 * 60 # Broadcast of prog started 3 mins late compared to NTP
    ...
    try:
        ...
        file = open(homedir + "/twitstream-waterlooroad.txt",'r')
        open = True
    except IOError, e:
    ...
    if open:
        ...
        for tweet in textarray:
            #print tweet
            firsttweettime = datetime(2010,9,8,19,0,0)
