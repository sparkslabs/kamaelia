...
"""\
===============================================================
Parse entities and their genders and relations definition received
===============================================================
...
def parseEntity(entityLine):
    ...
    if len(result) == 3:
        ...
        if 'gender' in attributes:
            gender = [x.split('=')[1].strip() for x in attributes_list if 'gender' in x]
        if gender[0] == 'Male':
            particle = 'Male'
        else:
            particle = 'Female'
...
class RelationGenderParser(Axon.Component.component):
    """\
=============================================================
