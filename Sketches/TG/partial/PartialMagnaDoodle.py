...
# Shards connected with module partial
...
class PartialMagnaDoodle(Axon.Component.component):
   """\
   ...
   def __init__(self, caption=None, position=None, margin=8, bgcolour = (124,124,124), fgcolour = (0,0,0), msg=None,
      ...
      super(PartialMagnaDoodle,self).__init__()
...
__kamaelia_components__  = ( PartialMagnaDoodle, )
...
if __name__ == "__main__":
   ...
   PMagna = PartialMagnaDoodle().activate()
