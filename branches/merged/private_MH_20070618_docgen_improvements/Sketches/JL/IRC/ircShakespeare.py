...
import sys
sys.path.append("../MPS")
from IRCClient import SimpleIRCClientPrefab as SimpleIRCClient
...
if __name__ == "__main__":
    ...
    Pipeline( RateControlledFileReader("twelfthnight.txt", readmode="lines", rate=50, chunksize=1),
              demodulation(),
              error_correction(),
              demultiplexing(),
              director("irc.ubuntu.net", "#theglobe"),
              ConsoleEchoer(),
            ).run()
