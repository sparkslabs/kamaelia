        ...
        *graph_options*, *node_options*, *edge_options* are
        ...
        for cls in self.all_classes:
            ...
            if url is not None:
                ...
                this_node_options['color'] = 'blue'
                this_node_options['style'] = 'filled'
                this_node_options['fillcolor'] = 'lightblue'
                this_node_options['fontcolor'] = 'blue'
            fd.write('  "%s" [%s];\n' %
                     (cls.__name__, self._format_node_options(this_node_options)))
...
def html_output_graph(self, node):
    ...
    path = '_static'
    png_path = os.path.join(self.builder.outdir, '_static', name + ".png")

    source = os.path.split(self.document.attributes['source'])[0]
    # Get a realtive path from source to _static
    while source != self.builder.srcdir:
