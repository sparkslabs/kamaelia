/* Generated by Pyrex 0.9.3 on Wed Jun 14 12:07:39 2006 */
...
static int __pyx_f_12vorbissimple_12vorbissimple___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_12vorbissimple_12vorbissimple___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
  static char *__pyx_argnames[] = {0};
  if (!PyArg_ParseTupleAndKeywords(__pyx_args, __pyx_kwds, "", __pyx_argnames)) return -1;
  Py_INCREF(__pyx_v_self);

  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":46 */
  ((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->sourceBuffer = newSourceBuffer(0,BUFSIZE);

  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":47 */
  ((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->oggVorbisContext = newOggVorbisContext();

  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":48 */
  ((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->decodeBuffer = 0;

  __pyx_r = 0;
  goto __pyx_L0;
  __pyx_L1:;
  __Pyx_AddTraceback("vorbissimple.vorbissimple.__init__");
  __pyx_r = -1;
  __pyx_L0:;
...
static PyObject *__pyx_f_12vorbissimple_12vorbissimple_sendBytesForDecode(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  while (1) {
    __pyx_L2:;
    __pyx_1 = PyInt_FromLong(__pyx_v_i); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; goto __pyx_L1;}
    __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_len); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; goto __pyx_L1;}
    ...
    if (PyObject_Cmp(__pyx_1, __pyx_4, &__pyx_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; goto __pyx_L1;}
    __pyx_5 = __pyx_5 < 0;
    Py_DECREF(__pyx_1); __pyx_1 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    if (!__pyx_5) break;

    /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":54 */
    __pyx_2 = __Pyx_GetName(__pyx_b, __pyx_n_ord); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; goto __pyx_L1;}
    __pyx_3 = PyInt_FromLong(__pyx_v_i); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; goto __pyx_L1;}
    __pyx_1 = PyObject_GetItem(__pyx_v_bytes, __pyx_3); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    ...
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __pyx_6 = PyInt_AsLong(__pyx_3); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    (((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->sourceBuffer->buffer[__pyx_v_i]) = __pyx_6;

    /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":55 */
  ...
  __pyx_4 = PyObject_CallObject(__pyx_1, __pyx_2); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_5 = PyInt_AsLong(__pyx_4); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  ((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->sourceBuffer->bytes = __pyx_5;
...
static PyObject *__pyx_f_12vorbissimple_12vorbissimple__getAudio(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":63 */
  ...
  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":64 */
  __pyx_1 = (((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->decodeBuffer->status == NEEDDATA);
  if (__pyx_1) {

    /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":65 */
  ...
  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":67 */
  __pyx_1 = (((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->decodeBuffer->status == HAVEDATA);
  if (__pyx_1) {

    /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":69 */
    __pyx_1 = (((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->decodeBuffer->len > 0);
    if (__pyx_1) {

      /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":70 */
      __pyx_2 = PyString_FromStringAndSize(((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->decodeBuffer->buffer,((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->decodeBuffer->len); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; goto __pyx_L1;}
      __pyx_r = __pyx_2;
      __pyx_2 = 0;
      goto __pyx_L0;
      goto __pyx_L5;
  ...
  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":74 */
  __pyx_1 = (((struct __pyx_obj_12vorbissimple_vorbissimple *)__pyx_v_self)->decodeBuffer->status == NORMAL);
  if (__pyx_1) {

    /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":75 */
  ...
  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":77 */
...
static PyObject *__pyx_f_12vorbissimple_12vorbissimple_fails(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/data/home/matteh/kamaelia/head/Code/Python/Bindings/vorbissimple/python/vorbissimple.pyx":81 */
...
statichere PyTypeObject __pyx_type_12vorbissimple_vorbissimple = {
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_f_12vorbissimple_12vorbissimple___init__, /*tp_init*/
  0, /*tp_alloc*/
