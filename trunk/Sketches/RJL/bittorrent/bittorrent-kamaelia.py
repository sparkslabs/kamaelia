...
if __name__ == '__main__':
    ...
    pipeline( ConsoleReader(">>> ", ""), TorrentClient("http://www.kanava.org/~bostonarch/btit/download.php?id=ca6ac4bbd971d3902935dbcfc2d3ea25b428a547&f=Lawrence%20Lessig%20-%20Free%20Culture%20%28PDF%29.torrent"), ConsoleEchoer(), Lagger() ).run()

    
""" may want to test with from Kamaelia.Util.ConsoleEcho import ConsoleEchoer
# should be Console for CVS, ConsoleEcho is for release
from Kamaelia.Util.PipelineComponent import pipeline """
