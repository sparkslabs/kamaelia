...
urlpatterns = patterns('',
    ...
    (r'^programmesv2/(?P<pid>\w+)/(?P<timestamp>\d+)/(?P<redux>\D+)$', 'bookmarks.output.views.programmev2'),
    (r'^programmesv2/(?P<pid>\w+)/(?P<timestamp>\d+)$', 'bookmarks.output.views.programmev2'),
    (r'^programmesv2/(?P<pid>\w+)/(?P<redux>\D+)$', 'bookmarks.output.views.programmev2'),
    (r'^programmesv2/(?P<pid>\w+)/$', 'bookmarks.output.views.programmev2'),
    (r'^data/tagcloud/(?P<pid>\w+)/(?P<timestamp>\d+)/(?P<elements>\D+)$', 'bookmarks.output.views.tagcloud'),
    (r'^data/tagcloud/(?P<pid>\w+)/(?P<timestamp>\d+)/(?P<aggregated>\D+)/(?P<elements>\D+)$', 'bookmarks.output.views.tagcloud'),
    ...
    (r'^channelsv2/(?P<channel>\w+)/(?P<year>\d+)/(?P<month>\d+)/(?P<day>\d+)/$', 'bookmarks.output.views.channelv2'),
    (r'^channelsv2/(?P<channel>\w+)/(?P<year>\d+)/(?P<month>\d+)/$', 'bookmarks.output.views.channelv2'),
    (r'^channelsv2/(?P<channel>\w+)/(?P<year>\d+)/$', 'bookmarks.output.views.channelv2'),
    (r'^channelsv2/(?P<channel>\w+)/$', 'bookmarks.output.views.channelv2'),
    (r'^channel-graphv2/(?P<channel>\w+)/(?P<year>\d+)/(?P<month>\d+)/(?P<day>\d+)/$', 'bookmarks.output.views.channelgraphv2'),
    (r'^channel-graphv2/(?P<channel>\w+)/(?P<year>\d+)/(?P<month>\d+)/$', 'bookmarks.output.views.channelgraphv2'),
    (r'^channel-graphv2/(?P<channel>\w+)/(?P<year>\d+)/$', 'bookmarks.output.views.channelgraphv2'),
    (r'^channel-graphv2/(?P<channel>\w+)/$', 'bookmarks.output.views.channelgraphv2'),
