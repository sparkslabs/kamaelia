...
if __name__=='__main__':
    ...
    CUBEC = SimpleCube(position=(0, 0,-12), name="Center cube").activate()
    CUBER = SimpleCube(position=(4,0,-22), name="Right cube").activate()
    CUBEB = SimpleCube(position=(0,-4,-18), name="Bottom cube").activate()
