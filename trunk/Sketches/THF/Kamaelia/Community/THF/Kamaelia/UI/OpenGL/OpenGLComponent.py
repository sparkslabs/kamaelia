...
class OpenGLComponent(Axon.AdaptiveCommsComponent.AdaptiveCommsComponent):#(Axon.ThreadedComponent.threadedadaptivecommscomponent):
    Inboxes = {
       "inbox": "not used",
       "control": "ignored",
    ...
    def __init__(self, **argd):
        ...
        self.rot = Vector( *argd.get("rotation", (0.0,0.0,0.0)) )
