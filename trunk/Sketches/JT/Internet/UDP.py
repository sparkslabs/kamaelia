...
class SimplePeer(BasicPeer):
    ...
    def main(self):
        ...
        while 1:
            ...
            # Put the component to sleep - this breaks receiving, but stops it
            # from munching all the CPU.  Non horribly broken fix lives
            # somewhere within /Sketches/MH/RTP, using a modified CSA and 
            # selector.
